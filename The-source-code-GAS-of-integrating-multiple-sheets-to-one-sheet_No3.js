...
//1つに統合したいシート名を指定する(シート名が違えば名前を変更する必要あり)
...

	{
		...
		//1つに統合したいシート名を指定する
		spreadsheet.setActiveSheet(spreadsheet.getSheetByName('Data2'), true);

		//検索　取得した値を入れる
		var sheet = spreadsheet.getSheetByName('Data2');
		//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑change↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑-
...
//1つに統合したいシート名を指定する(シート名が違えば名前を変更する必要あり)
...

	{
		...
		//1つに統合したいシート名を指定する
		spreadsheet.setActiveSheet(spreadsheet.getSheetByName('Data3'), true);

		//検索　取得した値を入れる
		var sheet = spreadsheet.getSheetByName('Data3');
		//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑change↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑-
